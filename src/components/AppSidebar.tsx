...
const nav = [
  ...
  { section: "DIAGNOSE", color: "cat-diagnose", cssVar: "--cat-diagnose", items: [
    { title: "Autopsy Room", url: "/diagnose/video-death", icon: AlertTriangle },
    { title: "Channel Roast", url: "/diagnose/roast", icon: Flame },
    { title: "Health Check", url: "/diagnose/health-check", icon: HeartPulse },
    { title: "Growth Intelligence", url: "/diagnose/growth-intelligence", icon: Brain },
    { title: "Algorithm Intelligence", url: "/diagnose/algorithm-intelligence", icon: ZapIcon },
  ...
  { section: "CREATE", color: "cat-create", cssVar: "--cat-create", items: [
    ...
    { title: "Script Improver", url: "/create/script-improver", icon: PenLine },
  ...
  { section: "GROW", color: "cat-grow", cssVar: "--cat-grow", items: [
    { title: "Lightning Lab", url: "/grow/lightning-lab", icon: Zap },
    { title: "Niche Gap", url: "/grow/niche-gap", icon: GitCompare },
    { title: "Hidden Gold", url: "/grow/hidden-gold", icon: Star },
    ...
    { title: "Launch Plan", url: "/grow/launch-plan", icon: CalendarDays },
  ...
  { section: "ANALYSE", color: "cat-analyze", cssVar: "--cat-analyze", items: [
    ...
    { title: "Shorts vs Longs", url: "/analyze/shorts-vs-longs", icon: GitCompare },
