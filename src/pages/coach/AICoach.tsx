...
import { Bot, Send, Zap, MessageSquare, TrendingDown, Heart, Swords } from "lucide-react";
...
export default function AICoach() {
  ...
  async function initCoach() {
    try {
      ...
      setMessages([{ role: "assistant", content: "Hey! I'm Max, your AI growth coach. Connect your YouTube channel and I'll give you personalized advice based on your real data. What's on your mind?" }]);
    } finally {
  ...
  async function sendMessage(text?: string) {
    ...
    try {
      ...
      setMessages([...newMessages, { role: "assistant", content: "Sorry, I had a moment there. Could you try again?" }]);
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="px-6 py-4 border-t border-border bg-card/50 backdrop-blur-sm">
        <div className="max-w-2xl mx-auto flex gap-3">
          <Input
            ...
            disabled={loading}
          />
          <Button size="lg" className="h-12 px-6 rounded-xl" onClick={() => sendMessage()} disabled={loading || !input.trim()}>
